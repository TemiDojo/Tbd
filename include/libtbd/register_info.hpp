#ifndef TBD_REGISTER_INFO_HPP
#define TBD_REGISTER_INFO_HPP
...
namespace tbd {
	enum class register_id {
		#define DEFINE_REGISTER(name,dwarf_id,size,offset,type,foramt) name
		#include <libtbd/detail/registers.inc>
